...
lens_data = {
    "관계": {
        "정의": "서로 다른 요소 사이에 존재하는 <b>연관성</b> 또는 <b>관련</b>이 있는 상태를 의미함.",
        "특징": "- 각 요소 중 하나 이상에 <b>변화</b>가 나타남<br> - 요소 간 주고받는 영향을 통해 복합적인 <b>의미</b>가 나타남"
    },
    "변화": {
        "정의": "사물이나 현상의 성질, 모양, 상태 바뀌어 달라지는 현상.",
        "특징": "- <b>원인, 과정, 결과</b>에서 무엇이, 어떻게, 왜 달라지는지 설명할 수 있음<br>- 연속적 혹은 불연속적으로 일어날 수 있음"
    }
}
lens_map = {
    "생태계와 환경 변화": "관계",
